...
ggsave('fig2_1.png', width = 4, height = 2, dpi = 300)
...
plot2 <- ggplot(df, aes(x = y, y = U_T)) +
  ...
  labs(x = 'Size of fireworks show',
       y = 'Total utility')
ggsave('fig2_2.png', width = 4, height = 2, dpi = 300)
```
  \begin{figure}[h!]
    \centering
...
ggsave('fig2_4_c.png', height = 2, width = 4, dpi = 300)
```
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{fig2_4_c.png}
...
ggsave('fig2_5_2.png', height = 2, width = 4, dpi = 300)
```
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{fig2_5_2.png}
