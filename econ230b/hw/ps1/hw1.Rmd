...
if(!file.exists('fig1_1a.png') | reload) {
  ...
  ggsave('fig1_1a.png', height = 3, width = 6, dpi = 300)
}
```
...
a. Sketch their indifference curves on a diagram.  
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{fig1_1a.png}
...
if(!file.exists('fig1_2.png') | !file.exists('fig1_3.png') | reload) {
  ...
  ggsave('fig1_2.png', height = 3, width = 3, dpi = 300)
  ...
  ggsave('fig1_3.png', height = 3, width = 3, dpi = 300)
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{fig1_3.png}
...
if(!file.exists('fig1_4.png') | reload) {
  ...
  ggsave('fig1_4.png', height = 3, width = 6, dpi = 300)
...
of ink). Show the locus Pareto optimal situations.
  \begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{fig1_4.png}
    \caption{Indifference curves for Anne and Bruce}
  \end{figure}
...
if(!file.exists('fig1_5.png') | reload) {
  df <-  crossing(c = seq(0, 30, .1),
                  t = seq(0, 30, .1)) %>%
    mutate(Anne  = -((c - 20)^2 + (t - 25)^2),
           Bruce = -((c - 10)^2 + (t - 15)^2),
  ...
  ggsave('fig1_5.png', height = 3, width = 6, dpi = 300)
}
```
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=\linewidth]{fig1_5.png}
